...
const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    'services.bento.web.title': 'Web Development',
    'services.bento.web.body': 'Turning concepts into high-performance experiences through story-driven websites and premium solutions.',
    'services.bento.brand.title': 'Branding',
    'services.bento.brand.body': 'Designing strategic identities that position brands at the premium end of their market.',
    'services.bento.software.title': 'Software / AI',
    'services.bento.software.body': 'Replacing manual processes with intelligent software tailored to your specific operations.',
    'services.bento.mobile.title': 'Mobile Applications',
    'services.bento.mobile.body': 'Custom built mobile apps engineered for performance, usability, and scalability beyond the web.',
    'services.bento.viewProjects': 'View Projects',
    'services.bento.center.line1': 'Everything in',
    'services.bento.center.line2': 'One Place',
    'services.bento.mock.hero': 'HERO BLACK',
    'services.bento.mock.next': 'NEXT',
    'services.bento.brand.studio': 'STUDIO',
    'services.bento.brand.launch': 'LAUNCH',
    'services.bento.task.completed': 'Task completed',
    'services.bento.task.updated': 'Updated schedule',
    'services.bento.task.added': 'Added new exercise',

    'project.backToWork': 'Back to work',
    'project.liveProject': 'Live Project',
    'project.startSimilarBuild': 'Start a Similar Build',
    'project.outcomes': 'Outcomes',
    'project.stack': 'Stack',
    'project.osos.summary': 'A real estate services platform focused on search, property discovery, and a trusted digital presence for buyers and operators.',
    'project.osos.outcome1': 'Structured discovery flows',
    'project.osos.outcome2': 'Responsive Angular interface',
    'project.osos.outcome3': 'Dynamic content foundation',
    'project.ajyal.summary': 'A learning-focused web experience for course information, registration, and student-facing school communication.',
    'project.ajyal.outcome1': 'Clear course presentation',
    'project.ajyal.outcome2': 'Fast registration path',
    'project.ajyal.outcome3': 'Mobile-first information architecture',
    'project.zaytona.summary': 'A polished product and service showcase for an agriculture brand that needs clarity, speed, and reliable presentation.',
    'project.zaytona.outcome1': 'Product-led content system',
    'project.zaytona.outcome2': 'Responsive visual showcase',
    'project.zaytona.outcome3': 'Clean service discovery',
    'project.stack.responsiveUi': 'Responsive UI',
    'project.stack.contentArchitecture': 'Content Architecture',
    'project.stack.educationUx': 'Education UX',
    'project.stack.brandUi': 'Brand UI',
    'project.stack.responsiveLayout': 'Responsive Layout',
    ...
    'cyber.capability.pt.meta': 'Find exploitable paths',
    ...
    'cyber.capability.api.meta': 'Validate access boundaries',
    ...
    'cyber.capability.vuln.meta': 'Rank real risk',
    ...
    'cyber.capability.hardening.meta': 'Ship safer fixes',
    ...
    'tech.item.angular': 'Angular',
    'tech.item.typescript': 'TypeScript',
    'tech.item.signals': 'Signals',
    'tech.item.standaloneUi': 'Standalone UI',
    'tech.item.forms': 'Forms',
    'tech.item.gsap': 'GSAP',
    'tech.item.apiIntegration': 'API Integration',
    'tech.item.seo': 'SEO',
    'tech.item.performance': 'Performance',
    'tech.item.deployment': 'Deployment',
    'tech.item.productStrategy': 'Product Strategy',
    'tech.item.uxArchitecture': 'UX Architecture',
    'tech.item.designSystems': 'Design Systems',
    'tech.item.dashboards': 'Dashboards',
    'tech.item.saas': 'SaaS',
    'tech.item.adminPanels': 'Admin Panels',
    'tech.item.leadFlow': 'Lead Flow',
    'tech.item.analytics': 'Analytics',
    'tech.item.handover': 'Handover',
    'tech.item.growth': 'Growth',
    'tech.board.strategy': 'STRATEGY',
    'tech.board.ux': 'UX',
    'tech.board.angular': 'ANGULAR',
    'tech.board.systems': 'SYSTEMS',
    'tech.board.launch': 'LAUNCH',
    'tech.board.growth': 'GROWTH',
  ...
  ar: {
    ...
    'tech.item.typescript': 'TypeScript',
    'tech.item.signals': 'Signals',
    'tech.item.standaloneUi': 'واجهات Standalone',
    'tech.item.forms': 'النماذج',
    'tech.item.gsap': 'GSAP',
    'tech.item.apiIntegration': 'تكامل API',
    'tech.item.seo': 'SEO',
    'tech.item.performance': 'الأداء',
    'tech.item.deployment': 'النشر',
    'tech.item.productStrategy': 'استراتيجية المنتج',
    'tech.item.uxArchitecture': 'هندسة تجربة المستخدم',
    'tech.item.designSystems': 'أنظمة التصميم',
    'tech.item.dashboards': 'لوحات التحكم',
    'tech.item.saas': 'SaaS',
    'tech.item.adminPanels': 'لوحات الإدارة',
    'tech.item.leadFlow': 'مسار العملاء المحتملين',
    'tech.item.analytics': 'التحليلات',
    'tech.item.handover': 'التسليم',
    'tech.item.growth': 'النمو',
    'tech.board.strategy': 'استراتيجية',
    'tech.board.ux': 'UX',
    'tech.board.angular': 'Angular',
    'tech.board.systems': 'أنظمة',
    'tech.board.launch': 'إطلاق',
    'tech.board.growth': 'نمو',
    ...
    'services.bento.web.title': 'تطوير الويب',
    'services.bento.web.body': 'نحول الأفكار إلى تجارب عالية الأداء عبر مواقع مبنية حول القصة وحلول رقمية احترافية.',
    'services.bento.brand.title': 'الهوية البصرية',
    'services.bento.brand.body': 'نصمم هويات استراتيجية تضع العلامات في موقع أقوى وأكثر احترافية داخل السوق.',
    'services.bento.software.title': 'البرمجيات / الذكاء الاصطناعي',
    'services.bento.software.body': 'نستبدل العمليات اليدوية ببرمجيات ذكية مصممة لتناسب طريقة عملك.',
    'services.bento.mobile.title': 'تطبيقات الجوال',
    'services.bento.mobile.body': 'تطبيقات جوال مخصصة مبنية للأداء وسهولة الاستخدام وقابلية التوسع خارج الويب.',
    'services.bento.viewProjects': 'عرض المشاريع',
    'services.bento.center.line1': 'كل شيء في',
    'services.bento.center.line2': 'مكان واحد',
    'services.bento.mock.hero': 'واجهة رئيسية',
    'services.bento.mock.next': 'التالي',
    'services.bento.brand.studio': 'استوديو',
    'services.bento.brand.launch': 'إطلاق',
    'services.bento.task.completed': 'اكتملت المهمة',
    'services.bento.task.updated': 'تم تحديث الجدول',
    'services.bento.task.added': 'تمت إضافة عنصر جديد',

    'project.backToWork': 'العودة إلى الأعمال',
    'project.liveProject': 'المشروع المباشر',
    'project.startSimilarBuild': 'ابدأ مشروعًا مشابهًا',
    'project.outcomes': 'النتائج',
    'project.stack': 'التقنيات',
    'project.osos.summary': 'منصة خدمات عقارية تركز على البحث، اكتشاف العقارات، وبناء حضور رقمي موثوق للمشترين والمشغلين.',
    'project.osos.outcome1': 'تدفقات اكتشاف منظمة',
    'project.osos.outcome2': 'واجهة Angular متجاوبة',
    'project.osos.outcome3': 'أساس محتوى ديناميكي',
    'project.ajyal.summary': 'تجربة ويب تعليمية لعرض معلومات الدورات والتسجيل والتواصل مع الطلاب.',
    'project.ajyal.outcome1': 'عرض واضح للدورات',
    'project.ajyal.outcome2': 'مسار تسجيل سريع',
    'project.ajyal.outcome3': 'هيكلة معلومات موجهة للموبايل',
    'project.zaytona.summary': 'عرض مصقول للمنتجات والخدمات لعلامة زراعية تحتاج وضوحًا وسرعة وحضورًا موثوقًا.',
    'project.zaytona.outcome1': 'نظام محتوى موجه بالمنتج',
    'project.zaytona.outcome2': 'عرض بصري متجاوب',
    'project.zaytona.outcome3': 'اكتشاف واضح للخدمات',
    'project.stack.responsiveUi': 'واجهة متجاوبة',
    'project.stack.contentArchitecture': 'هندسة المحتوى',
    'project.stack.educationUx': 'تجربة تعليمية',
    'project.stack.brandUi': 'واجهة هوية بصرية',
    'project.stack.responsiveLayout': 'تخطيط متجاوب',
    ...
    'cyber.capability.pt.meta': 'كشف مسارات الاستغلال',
    'cyber.capability.pt.body':
    ...
    'cyber.capability.api.meta': 'تأكيد حدود الصلاحيات',
    'cyber.capability.api.body':
    ...
    'cyber.capability.vuln.meta': 'ترتيب المخاطر الفعلية',
    'cyber.capability.vuln.body':
    ...
    'cyber.capability.hardening.meta': 'إطلاق إصلاحات آمنة',
    'cyber.capability.hardening.body':
